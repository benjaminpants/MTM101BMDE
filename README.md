...
Thanks to [this project](https://github.com/BrokenByteOfCode/FixPluginTypesSerialization-LinuxSupportFork) for allowing for serialization to work correctly for custom classes, thus letting the CustomAnimator components serialize correctly.